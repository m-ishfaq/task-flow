...
| 12   | **Admin, identity extras & compliance**                                                    | Admin console, retention policies, DSAR export, crypto-shred erasure, audit UI, **TOTP, OAuth (Google/GitHub) with account linking, device inventory, impossible-travel**, SCIM + SAML if a customer requires it, SOC 2 evidence. Device inventory reads `platform.push_subscriptions` (Phase 9) as one of its sources rather than inventing a second device concept — see that phase's §3.7. **Wave 1 (org governance & platform admin) shipped:** [ai/phase-12-admin.md](ai/phase-12-admin.md), approved 2026-08-09 — `identity.orgs.status` enforcement, self-serve creation guardrails, atomic ownership transfer, and the platform-operator console (migration 0032, the `taskflow_platform_admin` trust tier, `platformRoute`, suspend/reactivate reach into the four Phase 9 sweeps). Remaining waves (retention, DSAR, crypto-shred, TOTP, OAuth, device inventory, SCIM/SAML, SOC 2) not yet scheduled.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 6 wks   |
