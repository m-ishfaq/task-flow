...
| 10   | **Automation & integrations** _spec drafted_                                               | Cross-product rules engine with loop protection, run history, outbound webhooks, public API + scoped tokens, Slack/GitHub integrations, importers, exporters. Also builds `apps/worker`, which PLAN.md has listed as "arriving" since Phase 0 — new background work lands there; the seven existing timers in `apps/api` migrate later, one at a time. Spec: [ai/phase-10-automation.md](ai/phase-10-automation.md), drafted 2026-08-11, nine decisions resolved in review, not yet approved to build.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | 6 wks   |
