...
| 8   | **Search** 📝 _drafted_                 | TQL tokenizer + parser onto the existing Phase 3 AST, cross-product indexing, saved filters, command palette. Full spec: [ai/phase-8-search.md](ai/phase-8-search.md) (draft, pending approval)                                                                                                                                                                                                                                                                                                     | 3 wks   |
