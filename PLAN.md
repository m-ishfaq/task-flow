...
| 12   | **Admin, identity extras & compliance**                                                    | Admin console, retention policies, DSAR export, crypto-shred erasure, audit UI, **TOTP, OAuth (Google/GitHub) with account linking, device inventory, impossible-travel**, SCIM + SAML if a customer requires it, SOC 2 evidence. Device inventory reads `platform.push_subscriptions` (Phase 9) as one of its sources rather than inventing a second device concept — see that phase's §3.7. **Wave 1 (org governance & platform admin — self-serve creation guardrails, ownership transfer, the platform-operator console) drafted:** [ai/phase-12-admin.md](ai/phase-12-admin.md), 2026-08-08, not yet approved.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | 6 wks   |
...
10.5's 2–3 weeks added 2026-08-11 — ≈ 85–88 weeks.**
