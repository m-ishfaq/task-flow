...
| 3.5 | **Work UX** 📋 _proposed_               | Sidebar hierarchy, optimistic mutations, inline creation, status + priority as fields, group-by/sort-by, List view, saved views, bulk actions, My Tasks, command palette. Full spec: [ai/phase-3.5-work-ux.md](ai/phase-3.5-work-ux.md). **Not approved — pushes Phase 4 and everything behind it back by its own length.**                                                                                                                                                                                        | 5–8 wks |
