...
| 3.5  | **Work UX** 🔨 _in progress_            | Sidebar hierarchy, optimistic mutations, inline creation, status + priority as fields, group-by/sort-by, List view, saved views, bulk actions, My Tasks, command palette. Full spec: [ai/phase-3.5-work-ux.md](ai/phase-3.5-work-ux.md). **Approved 2026-07-30.** Wave 1 (shell and feel) and Wave 2 (status, priority, grouping, List view) shipped; Wave 3 (saved views, bulk actions, My Tasks, palette) open. **Accepted cost: pushes Phase 4 and everything behind it back by its own length.**                                                                                                                                                                                                                                                                                           | 5–8 wks |
