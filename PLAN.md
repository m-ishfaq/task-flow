...
Split across two roadmap phases (§13): teams and role/group management shipped in Phase 2;
...
| 9    | **Notifications** _draft_               | Cross-channel routing (in-app/email/SMS/push), batching, granular preferences, digests, due reminders. Full spec: [ai/phase-9-notifications.md](ai/phase-9-notifications.md), drafted 2026-08-08, not yet approved.                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 3 wks   |
