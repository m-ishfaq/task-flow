...
| 6   | **Docs** 🔨 _Waves 1–2 shipped_         | Spaces, page tree, Hocuspocus + Yjs, inline comments, versions, templates, inherited permissions, publish. Waves 1–2 (tree/auth foundation, live sync + the three recovery paths) done; Waves 3–4 (comments, publish) open. Full spec: [ai/phase-6-docs.md](ai/phase-6-docs.md)                                                                                                                                                                                                                   | 8 wks   |
