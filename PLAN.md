...
| 6   | **Docs** 🔨 _Wave 1 shipped_            | Spaces, page tree, Hocuspocus + Yjs, inline comments, versions, templates, inherited permissions, publish. Wave 1 (tree/auth foundation) done; Waves 2–4 (live sync, comments, publish) open. Full spec: [ai/phase-6-docs.md](ai/phase-6-docs.md)                                                                                                                                                                                                                                                  | 8 wks   |
