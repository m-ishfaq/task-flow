...
| 6   | **Docs** 🔨 _Waves 1–3 shipped_         | Spaces, page tree, Hocuspocus + Yjs, inline comments, versions, templates, inherited permissions, publish. Waves 1–3 (tree/auth foundation, live sync + the three recovery paths, comments/suggestions/backlinks) done; Wave 4 (publish, PDF export, templates) open. Full spec: [ai/phase-6-docs.md](ai/phase-6-docs.md)                                                                                                                                                                          | 8 wks   |
